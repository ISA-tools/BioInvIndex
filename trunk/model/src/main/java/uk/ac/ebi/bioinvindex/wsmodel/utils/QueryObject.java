package uk.ac.ebi.bioinvindex.wsmodel.utils;
...
{
    private List<PropertyValuesWS> properties = new ArrayList<PropertyValuesWS>();

    private List<AssayTypeWS> assayTypes = new ArrayList<AssayTypeWS>();
