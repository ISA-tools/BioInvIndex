 ...
 *
 */
public class AssayUnloader extends AbstractReferrerUnloader<Assay>
{
	public AssayUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
	...
	public boolean queue ( Assay assay ) 
	{
		...
		unloadManager.queue ( assay.getTechnology () );
		return true;
	}
