...
public class ContactEJB3DAO extends IdentifiableEJB3DAO<Contact> implements ContactDao
{
	...
	public ContactEJB3DAO(EntityManager entityManager) {
		super(Contact.class, entityManager);
	}

	public List<Contact> findByBasicAttributes (
