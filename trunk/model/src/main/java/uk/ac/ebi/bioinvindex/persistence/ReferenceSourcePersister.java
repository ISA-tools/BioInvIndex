 ...
 *
 */
public class ReferenceSourcePersister extends AccessiblePersister<ReferenceSource>
{
	public ReferenceSourcePersister ( DaoFactory daoFactory, Timestamp submissionTs ) {
	 ...
	 */
	@Override
	public void preProcess ( ReferenceSource object ) {
		forwardPreProcess ( object );
	}
	...
	protected ReferenceSource lookup ( ReferenceSource source ) {
		return ((ReferenceSourceDAO) dao).getReferenceSourceByAcc ( source.getAcc() );
	}

	/**
	 * Caches by accession, for the benefit of certain objects (eg {@link Xref}), which often have copies of the
	 * same source.
	 */
	@Override
