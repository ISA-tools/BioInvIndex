...
public abstract class AbstractAccessibleUnloader<AT extends Accessible> extends AbstractAnnotatableUnloader<AT>
{
	public AbstractAccessibleUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
		dao = unloadManager.getDaoFactory ().getAccessibleDAO ( getUnloadedClass () );
	}
