...
public class Authenticator {
	...
	public boolean authenticate() {
		...
		//ToDo: hash password
		return userDAO.isValidCredentials(identity.getUsername(), StringEncryption.getInstance().encrypt(identity.getPassword()));
	}

	public void failed() {
		if (identity.getUsername() != null) {
			facesMessages.add("Invalid Login! Please try again");
		}
	}
}
