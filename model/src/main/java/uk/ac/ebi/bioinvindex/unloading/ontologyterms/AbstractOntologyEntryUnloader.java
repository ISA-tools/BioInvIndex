...
public abstract class AbstractOntologyEntryUnloader<OE extends OntologyEntry> extends AbstractAnnotatableUnloader<OE>
{
	public AbstractOntologyEntryUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
		dao = unloadManager.getDaoFactory ().getOntologyEntryDAO ( getUnloadedClass () );
	}
 ...
 {
	 OE object = ((OntologyEntryDAO<OE>)dao).getByAcc ( acc );
