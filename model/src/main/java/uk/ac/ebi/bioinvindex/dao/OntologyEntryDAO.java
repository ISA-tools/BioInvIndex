 ...
 * Date: Jan 16, 2008
 */
public interface OntologyEntryDAO<T extends OntologyEntry> extends AnnotatableDAO<T> {
	...
	public List<String> getOntologyEntryAccsByRefSource(String refSourceName);
}
