...
public class DataLocationPersister extends Persister<AssayTypeDataLocation>
{
	...
	/**
	 * Saves the associated {@link ReferenceSource}.
	 */
	@Override
	protected void preProcess ( AssayTypeDataLocation loc )
	{
		super.preProcess ( loc );
		ReferenceSource src = loc.getReferenceSource ();
		ReferenceSource srcDB = sourcePersister.persist ( src );
		if ( srcDB != src )
			loc.setReferenceSource ( srcDB );
	}
