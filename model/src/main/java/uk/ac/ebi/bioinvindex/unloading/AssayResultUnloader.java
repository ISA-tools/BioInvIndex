 ...
 *
 */
public class AssayResultUnloader extends AbstractUnloader<AssayResult>
{
	public AssayResultUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
//		logLevel = Level.DEBUG;
	...
	public boolean queue ( AssayResult ar )
	{
		...
		for ( PropertyValue<?> pval: ar.getCascadedPropertyValues () )
			unloadManager.queue ( pval );

		unloadManager.queue ( Data.class, ar.getData () );
		return true;
	}
}
