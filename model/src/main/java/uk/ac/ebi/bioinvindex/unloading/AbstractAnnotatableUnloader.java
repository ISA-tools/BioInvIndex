 ...
 * @param <A>
 */
public abstract class AbstractAnnotatableUnloader<A extends Annotatable> extends AbstractUnloader<A>
{
	public AbstractAnnotatableUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
	}
	...
	@Override
	protected void cancelDelete ( A object ) {
		super.cancelDelete ( object );
		unloadManager.unqueueAll ( object.getAnnotations () );
	}
