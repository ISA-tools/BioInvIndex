...
public class ParameterValue extends PropertyValue<Parameter>{
	...
	public ParameterValue ( String value, Parameter type ) {
	  super ( value, type );
  }



	@ManyToOne( targetEntity = uk.ac.ebi.bioinvindex.model.processing.ProtocolApplication.class)
