 ...
 *
 */
public class CharacteristicValuePersister extends AbstractPropertyValuePersister<CharacteristicValue>
{
	protected CharacteristicValuePersister ( DaoFactory daoFactory, Timestamp submissionTs ) {
