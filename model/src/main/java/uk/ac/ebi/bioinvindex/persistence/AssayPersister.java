 ...
 *
 */
public class AssayPersister extends ReferrerPersister<Assay>
{
	...
	public AssayPersister ( DaoFactory daoFactory, Timestamp submissionTs ) 
	{
		...
		measPersister = new OntologyEntryPersister<Measurement> ( daoFactory, submissionTs ) {};
		techPersister = new OntologyEntryPersister<AssayTechnology> ( daoFactory, submissionTs ) {};
		assayMaterialPersister = new AssayMaterialPersister ( daoFactory, submissionTs );
	...
	public void preProcess ( Assay assay ) 
	{
		...
		if ( technology != technologyDB )
			assay.setTechnology ( technologyDB );

		// End Point
		Measurement measurement = assay.getMeasurement ();
		Measurement measurementDB = (Measurement) measPersister.persist ( measurement );
