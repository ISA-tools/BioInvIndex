...
public abstract class AbstractNodeUnloader<N extends Node> extends AbstractGraphElementUnloader<N>
{
	public AbstractNodeUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
	}
}