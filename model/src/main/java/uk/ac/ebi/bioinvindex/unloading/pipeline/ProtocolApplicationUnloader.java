...
public class ProtocolApplicationUnloader extends AbstractAccessibleUnloader<ProtocolApplication>
{
	public ProtocolApplicationUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
	}
