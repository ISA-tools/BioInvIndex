...
public class ProtocolEquippedModel extends SimplePipelineModel {
    ...
    public ProtocolEquippedModel() {
        ...
        proto1 = new Protocol("Protocol 1", null);
        proto1.setAcc("proto1");
        study.addProtocol(proto1);
        papp1 = new ProtocolApplication(proto1);
        papp1.setAcc("papp1");
        ...
        proto2 = new Protocol("Protocol 2", null);
        proto2.setAcc("proto2");
        study.addProtocol(proto2);
        papp2 = new ProtocolApplication(proto2);
        papp2.setAcc("papp2");
