...
public class SimplePipelineModel {
    ...
    public SimplePipelineModel() {
        ...
        nsrc1 = new MaterialNode(study);
        nsrc1.setAcc("nsrc1");
        src1 = new Material("Source Material 1", srcRole);
        src1.setAcc("src1");
        ...
        nsrc2 = new MaterialNode(study);
        nsrc2.setAcc("nsrc2");

        src2 = new Material("Source Material 2", srcRole);
        src2.setAcc("src2");

        nsrc2.setMaterial(src2);

        p1 = new MaterialProcessing(study);
        p1.setAcc("p1");
        ...
        nas1 = new MaterialNode(study);
        nas1.setAcc("nas1");

        assayMaterial1 = new Material("Assay Material 1", assayRole);
        assayMaterial1.setAcc("assayMaterial1");
        nas1.setMaterial(assayMaterial1);
        p1.addOutputNode(nas1);
        p2 = new DataAcquisition(study);
        p2.setAcc("p2");

        p2.addInputNode(nas1);

        nar1 = new DataNode(study);
        nar1.setAcc("nar1");


        dt1 = new Data("data1.txt", dataType);
        dt1.setAcc("dt1");
        ...
        nar2 = new DataNode(study);
        nar2.setAcc("nar2");

        dt2 = new Data("data2.txt", dataType);
        dt2.setAcc("dt2");
        nar2.setData(dt2);
