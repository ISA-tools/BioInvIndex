...
//@Indexed(index = "bii")
public class Measurement extends OntologyEntry{

	protected Measurement() {
		super();
	}

	protected Measurement(String name, ReferenceSource source) {
		super(name, source);
	}

	public Measurement(String acc, String name, ReferenceSource source) {
