...
/**
 * Object representing the series of manipulations that occur to the {@link uk.ac.ebi.bioinvindex.model.Data}.
 *
 * @author Nataliya Sklyar (nsklyar@ebi.ac.uk)
 * Date: Jul 30, 2007
 */
@Entity
@DiscriminatorValue( "DataProcessing" )
public class DataProcessing extends Processing<DataNode, DataNode>{

	public DataProcessing() {
		super();
	}

	public DataProcessing(Study study) {
		super(study);
	}

	public DataProcessing(Study study, boolean original) {
