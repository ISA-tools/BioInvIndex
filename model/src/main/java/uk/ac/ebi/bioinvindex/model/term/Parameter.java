...
public class Parameter extends Property<ParameterValue>{

	protected Parameter() {
	}

	public Parameter(String value, int order) {
		super(value, PropertyRole.PROPERTY, order);
	}

	public Parameter( int order ) {
		super(PropertyRole.PROPERTY, order);
	}

	// Submission tool needs this
	public Parameter( String value ) {
		super ();
		this.setRole ( PropertyRole.PROPERTY );
		this.setValue ( value );
	}
