 ...
 *
 */
public class ParameterValuePersister extends AbstractPropertyValuePersister<ParameterValue>
{
	public ParameterValuePersister ( DaoFactory daoFactory, Timestamp submissionTs ) {
