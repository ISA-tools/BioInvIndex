 ...
 *
 */
public class ProtocolUnloader extends AbstractAccessibleUnloader<Protocol>
{
	public ProtocolUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
	}
	...
	public boolean queue ( Protocol proto )
	{
		...
		unloadManager.queueAll ( Parameter.class, proto.getParameters () );
		unloadManager.queueAll ( ProtocolComponent.class, proto.getComponents () );
		return true;
	}
