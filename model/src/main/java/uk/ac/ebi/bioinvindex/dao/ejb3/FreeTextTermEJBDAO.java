...
public class FreeTextTermEJBDAO<FT extends FreeTextTerm> extends AnnotatableEJB3DAO<FT> implements FreeTextTermDAO<FT>
{
	public FreeTextTermEJBDAO () {
		super ();
	}

	public FreeTextTermEJBDAO ( Class<FT> persistentClass, EntityManager entityManager ) {
		super ( persistentClass, entityManager );
	}

	public FreeTextTermEJBDAO ( Class<FT> persistentClass ) {
