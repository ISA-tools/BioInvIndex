 ...
 *
 */
public class CharacteristicValueUnloader extends AbstractPropertyValueUnloader<CharacteristicValue>
{
	public CharacteristicValueUnloader ( UnloadManager unloadManager ) {
		super ( unloadManager );
	}
}
